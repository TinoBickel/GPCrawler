...
{    
    ...
    public class Equalizer : Control
    {
        ...
        /// </summary>
        public static readonly DependencyProperty NumberOfBandsProperty = DependencyProperty.Register("NumberOfBands", typeof(int), typeof(Equalizer), new UIPropertyMetadata(32, OnNumberOfBandsChanged, OnCoerceNumberOfBands));
